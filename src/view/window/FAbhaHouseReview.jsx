...
class FAbhaHouseReview extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Input size={'xs'} absolute={true} x={'132px'} y={'19px'} width={'128px'}/>
                ...
                <Input size={'xs'} absolute={true} x={'184px'} y={'129px'} width={'116px'}/>
                ...
                <Input size={'xs'} absolute={true} x={'496px'} y={'100px'} width={'116px'}/>
                ...
                <Input size={'xs'} absolute={true} x={'140px'} y={'158px'} width={'160px'}/>
