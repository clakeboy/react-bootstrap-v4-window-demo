...
class FAbhoHouseReview extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Input size={'xs'} absolute={true} x={'132px'} y={'20px'} width={'128px'}/>
                ...
                <Input size={'xs'} absolute={true} x={'452px'} y={'104px'} width={'116px'}/>
                ...
                <Input size={'xs'} absolute={true} x={'300px'} y={'20px'} width={'96px'}/>
                <Input size={'xs'} absolute={true} x={'300px'} y={'48px'} width={'96px'}/>
                <Input size={'xs'} absolute={true} x={'452px'} y={'20px'} width={'116px'}/>
                <Label sm={true} text={'ATD'} absolute={true} x={'416px'} y={'20px'} width={'28px'} height={'20px'} color={'rgb(18,0,0)'} backColor={'rgb()'}/>
                <Input size={'xs'} absolute={true} x={'452px'} y={'48px'} width={'116px'}/>
                <Label sm={true} text={'ATA'} absolute={true} x={'416px'} y={'48px'} width={'28px'} height={'20px'} color={'rgb(18,0,0)'} backColor={'rgb()'}/>
                <Input size={'xs'} absolute={true} x={'128px'} y={'160px'} width={'160px'}/>
