            ...
            <React.Fragment>
                <Tabs sm={true} border={true} absolute={true} x={'0px'} y={'1px'} width={'844px'} height={'522px'}>
                    <TabsContent id='ManifestStatus' text='Manifest Status' active>
                        <Input size={'xs'} absolute={true} x={'112px'} y={'43px'} width={'112px'}/>
