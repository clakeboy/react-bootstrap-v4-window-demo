    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Input size={'xs'} absolute={true} x={'448px'} y={'76px'} width={'92px'}/>
